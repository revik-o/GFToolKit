    ...
    return (
        ...
        >
            <div className="flex h-16 items-center justify-between px-4 border-b border-zinc-900">
                {!isCollapsed && <span className="text-xl font-bold text-zinc-50 tracking-tight">GF Tool Kit</span>}
                {isCollapsed && <span className="text-xl font-bold text-zinc-50 tracking-tight mx-auto">GF</span>}
    ...
    return (
        <Sheet open={open} onOpenChange={setOpen}>
            <SheetTrigger asChild>
                <Button variant="ghost" size="icon" className="lg:hidden text-zinc-400 hover:text-zinc-50 hover:bg-zinc-900">
                    <Menu size={24} />
                    <span className="sr-only">Toggle Menu</span>
                </Button>
            </SheetTrigger>
            <SheetContent side="left" className="w-72 bg-zinc-950 border-r-zinc-900 p-0 text-zinc-50">
                <SheetHeader className="p-4 border-b border-zinc-900 text-left">
                    <SheetTitle className="text-xl font-bold text-zinc-50">GF Tool Kit</SheetTitle>
                </SheetHeader>
