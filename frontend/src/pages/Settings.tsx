  ...
  useEffect(() => {
    const loadSettings = async () => {
      ...
      const [settingsRes, userRes] = await Promise.all([
        fetchApi<{ avatar_url: string; theme: string }>(
          "/api/v1/user/settings/read",
        ),
    ...
    <div className="flex h-full flex-col bg-zinc-950 text-zinc-50 p-6 overflow-y-auto">
      <div className="mb-8">
        ...
        <p className="text-zinc-400 mt-1">
          Manage your account preferences and partner configurations
        </p>
      </div>
      ...
      <div className="grid gap-6 md:grid-cols-2 max-w-5xl">
        <Card className="bg-zinc-900 border-zinc-800 text-zinc-50">
          <CardHeader>
            ...
            <CardDescription className="text-zinc-400">
              Update your account identity and avatar
            </CardDescription>
          </CardHeader>
        ...
        <Card className="bg-zinc-900 border-zinc-800 text-zinc-50">
          <CardHeader>
            ...
            <CardDescription className="text-zinc-400">
              Update your credentials. Leave blank to keep current password.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="space-y-2">
        ...
        <Card className="bg-zinc-900 border-zinc-800 text-zinc-50">
          <CardHeader>
            ...
            <CardDescription className="text-zinc-400">
              Customize the application aesthetics
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="space-y-2">
        ...
        <Card className="bg-zinc-900 border-zinc-800 text-zinc-50">
          <CardHeader>
            ...
            <CardDescription className="text-zinc-400">
              Link your account with your partner's email address and share
              resources
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="space-y-2">
              <Label htmlFor="partnerAuth" className="text-zinc-300">
                Partner Email
              </Label>
              <Input
                id="partnerAuth"
